...
from platforms.whatsapp.client import send_cta_button, send_image, send_location, send_text,send_document
...
def _format_rag_docs(docs: list) -> str:
    """
    Convert retrieved documents into clean,
    LLM-friendly text.
    """
...
def rag_tool(query: str) -> str:
    """Retrieve information about the homestay / therapy center."""
    try:
