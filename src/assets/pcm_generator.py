...
async def main():
    chunks = []
    sentence_q = _q.Queue()
    sentence_q.put("Hey, I’m Zia. I help businesses handle customer enquiries instantly and convert more leads.Just curious — how are you currently managing your incoming messages or calls?")
